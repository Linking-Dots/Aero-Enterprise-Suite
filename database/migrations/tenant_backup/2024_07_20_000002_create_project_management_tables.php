...
return new class extends Migration
{
    ...
    {
        // Only extend projects table if it already exists
        ...
        // Only create project-related tables if projects table exists
        if (Schema::hasTable('projects')) {
        ...
        } // End if (Schema::hasTable('projects'))
    }
    ...
    {
        // Only drop project-related tables if they exist
        if (Schema::hasTable('projects')) {
