...
export const getThemeClasses = (themeColor, variant = 'primary') => {
  const colorMap = {
    'OCEAN': {
      ...
      gradientPrimary: 'bg-linear-to-r from-sky-400 to-sky-600',
      gradientSecondary: 'bg-linear-to-r from-blue-400 to-blue-600',
      gradientAccent: 'bg-linear-to-r from-cyan-400 to-blue-600',
      gradientLight: 'bg-linear-to-r from-sky-100 to-blue-100',
      gradientDark: 'bg-linear-to-r from-sky-800 to-blue-900',
      gradientSubtle: 'bg-linear-to-r from-sky-50 to-blue-50',
    ...
    'EMERALD': {
      ...
      gradientPrimary: 'bg-linear-to-r from-emerald-400 to-emerald-600',
      gradientSecondary: 'bg-linear-to-r from-teal-400 to-teal-600',
      gradientAccent: 'bg-linear-to-r from-green-400 to-teal-600',
      gradientLight: 'bg-linear-to-r from-emerald-100 to-teal-100',
      gradientDark: 'bg-linear-to-r from-emerald-800 to-teal-900',
      gradientSubtle: 'bg-linear-to-r from-emerald-50 to-teal-50',
    ...
    'AMETHYST': {
      ...
      gradient: 'bg-linear-to-r from-violet-500 to-purple-600',
      gradientPrimary: 'bg-linear-to-r from-violet-400 to-violet-600',
      gradientSecondary: 'bg-linear-to-r from-purple-400 to-purple-600',
      gradientAccent: 'bg-linear-to-r from-indigo-400 to-purple-600',
      gradientLight: 'bg-linear-to-r from-violet-100 to-purple-100',
      gradientDark: 'bg-linear-to-r from-violet-800 to-purple-900',
      gradientSubtle: 'bg-linear-to-r from-violet-50 to-purple-50',
    ...
    'CORAL': {
      ...
      gradientPrimary: 'bg-linear-to-r from-orange-400 to-orange-600',
      gradientSecondary: 'bg-linear-to-r from-red-400 to-red-600',
      gradientAccent: 'bg-linear-to-r from-amber-400 to-red-600',
      gradientLight: 'bg-linear-to-r from-orange-100 to-red-100',
      gradientDark: 'bg-linear-to-r from-orange-800 to-red-900',
      gradientSubtle: 'bg-linear-to-r from-orange-50 to-red-50',
      button: 'bg-orange-500 hover:bg-orange-600 text-white'
    },    'ROSE': {
      primary: 'text-rose-500',
      bg: 'bg-rose-500/10 hover:bg-rose-500/20',
      border: 'border-rose-500/30 hover:border-rose-500',
      gradient: 'bg-linear-to-r from-rose-500 to-pink-600',
      gradientPrimary: 'bg-linear-to-r from-rose-400 to-rose-600',
      gradientSecondary: 'bg-linear-to-r from-pink-400 to-pink-600',
      gradientAccent: 'bg-linear-to-r from-red-400 to-pink-600',
      gradientLight: 'bg-linear-to-r from-rose-100 to-pink-100',
      gradientDark: 'bg-linear-to-r from-rose-800 to-pink-900',
      gradientSubtle: 'bg-linear-to-r from-rose-50 to-pink-50',
    ...
    'SLATE': {
      ...
      gradient: 'bg-linear-to-r from-slate-500 to-gray-600',
      gradientPrimary: 'bg-linear-to-r from-slate-400 to-slate-600',
      gradientSecondary: 'bg-linear-to-r from-gray-400 to-gray-600',
      gradientAccent: 'bg-linear-to-r from-zinc-400 to-slate-600',
      gradientLight: 'bg-linear-to-r from-slate-100 to-gray-100',
      gradientDark: 'bg-linear-to-r from-slate-800 to-gray-900',
      gradientSubtle: 'bg-linear-to-r from-slate-50 to-gray-50',
